...
- извлечение и систематизация фактов из текста, в том числе автоматическое
  построение графовых моделей текста;
- сбор и аннотирование данных для задач обработки и понимания естественного
  языка;
- выявление содержательных, логических и фактических ошибок;
- синтез человекочитаемого текста на основе ранее выявленной информации и
  запросов пользователя.
 
2. Назначение научно-технического продукта (изделия и т.п.)
 
САДС предназначена для использования при подготовке технической,
технологической, отчасти конструкторской документации и других видов
технического и научно-технического текста. САДС предполагает работу
технического писателя в режиме "пост редактирования" аналогично системам
класса Памяти перевода (TM systems), широко применяемым в переводе
научно-технических текстов.
 
В отличие от них она предполагает частичный синтез текста автоматическими
алгоритмами, учет широкого контекста документации по проекту и по предметной
области проекта. На данном этапе планируется разработка действующего
прототипа.
...
1) Извлечение фактов из текста на естественном языке,
2) Построение иерархической модели предметной области и текста,
3) Оценка соответствия стиля научно-техническому,
4) Автоматизация генерации заготовок таких фрагментов текста как:
- обозначения и определения,
- описание изделия по составу входящих в него компонентов,
- аннотация, реферат, введение, заключение.
5) Автоматическая проверка текста на соответствие требованиям к содержанию.
6) Суммаризация внесенных в текст изменений.
7) Генерация блок-схемы по текстовому описанию или программному коду.
 
3.2 Количественные параметры, определяющие выполнение научно-техническим продуктом
своих функций
 
1) Объем обрабатываемых документов - от 100 симв. до 200 тыс. симв.
2) Глубина рекурсии при анализе/генерации иерархических моделей - не менее 5.
3) Число классов детектора стилей - не менее 3.
4) Время генерации заготовки документа (не включая время обучения модели) - не более 10 сек.
5) Поддержка сетевых баз данных и поисковых систем - не менее 3.
...
Cостав САДС
- Подсистема импорта данных о структуре предметной области из публичных
  сетей.
- Подсистема анализа нормативной документации.
- Подсистема анализа проектной документации.
- Подсистема генерации человеко-читаемого текста
  а) основанная на шаблонах,
  б) основанная на нейросетевых моделях.
- Подсистема контроля версий.
- Подсистема хранения данных.
- Подсистема экпорта данных.
...
1. Процессор Intel Core i9 или аналогичный.
2. Плата Gigabyte LGA 1200 B560 или аналогичная.
3. Жесткий диск SATA-3 4 ТБ (4шт).
4. Память DIMM DDR4 32768 MB (4шт) или аналогичная.
5. БП 560W, не менее.
6. 250 ГБ SSD M.2 накопитель.
